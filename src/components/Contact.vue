...
<div class="container">
	<div class="wrapper">
		<div class="my-info">
			<h3>Find me here</h3>
			<ul>
				<li><i class="fa fa-road"></i>Cape Town, Western Cape</li><br>
				<li><i class="fa fa-phone"></i> (+27) 731576799</li><br>
				<li><i class="fa fa-envelope"></i> emanuelfente97@gmail.com</li>
			</ul>
		</div>
	<!-- CONTACT FORM -->
    	<div class="contact">
        	...
        	<p>
					<label>Surname</label>
					<input type="text" name="surname" v-model="surname" id="surname">
				</p>
			<p>
		...
		<p>
				...
				<p class="full">
					...
					<textarea name="message" v-model="message" required rows="5" id="message"></textarea>
				</p>
				<p class="full">
